...
function Register() {
	...
	function checkInputs() {
		...
		const phonevalue = WebsiteRef.current.value.trim();
		...
		if (phonevalue === '') {
			setErrorFor(WebsiteRef.current, 'Username cannot be blank');
		  } else {
			setSuccessFor(WebsiteRef.current);
		  }
          ...
          <div className="container">
            ...
            <form id="form" className="form" onSubmit={handleSubmit} ref={formRef}>
              <div className="form-control">
                <label htmlFor="CompanyName">Fullname</label>
                <input type="text" placeholder="" id="CompanyName" ref={UsernameRef }/>
                <small>Error message</small>
              </div>

              <div className="form-control">
                <label htmlFor="Websitelink">Website</label>
                <input type="text" placeholder="" id="Websitelink" ref={WebsiteRef}/>
                <small>Error message</small>
              </div>
              ...
              <div className="form-control">
                <label htmlFor="cvr">CVR/Vat number</label>
              ...
              <div className="form-control">
                ...
                <label htmlFor="løsning">Connect your finance system</label>
				...
				<label style={{fontSize: '15px', fontWeight: '500' , fontFamily: 'Arial, sans-serif', border: 'none', marginTop: '10px', display: 'block', margin: 'auto', width: '95%'}}>
					...
					<input className='code' style={{border: 'solid black 1px'}}></input>

					<hr style={{border: "none" , borderBottom: 'dotted 7px orange', width: '200px'}}/>
				</label>
                <small>Error message</small>
              </div>
				...
				<button id="btn" style={{marginBottom: "20px"}} disabled>Submit</button>
		        </form>
	          </div>
				</body>
  ...
  return (
        ...
        <body>
          <div className="container">
            ...
            <form id="form" className="form" onSubmit={handleSubmit} ref={formRef}>
              <div className="form-control">
                <label htmlFor="CompanyName">Dit navn</label>
                <input type="text" placeholder="" id="CompanyName" ref={UsernameRef }/>
                <small>Error message</small>
              </div>

              <div className="form-control">
                <label htmlFor="Number">Telefonummer</label>
              ...
              <div className="form-control">
                <label htmlFor="Vikname">Virksomhedens Navn</label>
                <input type="text" placeholder="" id="Vikname" ref={CompanynameRef} />
                <small>Error message</small>
              </div>
			  <hr style={{marginTop: '30px', marginBottom: '10px' , lineHeight: '0px', border: 'none', alignContent: 'center', width: '200px', borderBottom: 'dotted orange 7px' }}></hr>
              ...
              <div className="form-control">
                <label htmlFor="løsning">Vælg løsning</label>
                <input type="text" id="løsning" list="løsning1" required />
                <datalist id="løsning1">
                  <option value="Demo 0dkk" />
                  <option value="Demo 12dkk" />
